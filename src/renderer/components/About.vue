<template>
  <main>
    ...
    <img src="static/images/PN_Logo.png" all="Passerelles Numeriques logo" />
    ...
    <hr />
    <div id="aboutLinks">
      <a href="https://www.passerellesnumeriques.org/" target="_blank">Passerelles Numériques</a>
      <a href="https://github.com/passerelles-numeriques/khmer-typing" target="_blank">Github</a>
      <a href="https://snapcraft.io/khmer-typing" target="_blank">Linux store (Snapraft)</a>
      <a>Windows store</a>
    </div>
  </main>
</template>
